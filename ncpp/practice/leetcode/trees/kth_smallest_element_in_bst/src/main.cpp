...
void get_element(const unique_ptr<TreeNode>& root, int k, int& count, int& res) {
...
int kthSmallest(const unique_ptr<TreeNode>& root, int k) {
	int count{1}, res{};
...
void solvethetestcase() {
	unique_ptr<TreeNode> root = make_unique<TreeNode>(15);
	root->left = make_unique<TreeNode>(9);
	root->right = make_unique<TreeNode>(18);
	root->left->left = make_unique<TreeNode>(6);
	root->left->right = make_unique<TreeNode>(12);
	root->left->left->left = make_unique<TreeNode>(3);
