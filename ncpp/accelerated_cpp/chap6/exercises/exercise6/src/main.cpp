...
int main(int argc, char **argv) {
	...
	// write_analysis for exercise6
	write_analysis(std::cout, "median", all_three_analysis, did, did_not);
	write_analysis(std::cout, "average", all_three_analysis, did, did_not);
	write_analysis(std::cout, "optimistic_median", all_three_analysis, did, did_not);
