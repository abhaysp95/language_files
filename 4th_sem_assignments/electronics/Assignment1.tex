...
\title{\textbf{\textsc{Assignment-1\\Electronics Engineering(KOE-048)\\Unit - 4}}}
...
\begin{figure}[hbt!]
	\centering
	\includegraphics[width=1\textwidth, angle=-90]{images/qna1.jpg}
...
\begin{figure}[hbt!]
	\centering
	\includegraphics[width=1\textwidth]{images/qna2.jpg}
