...
public class MainClass extends Applet implements Runnable {
	...
	public void init() {
		...
		this.e2 = new Enemy(600, 450, this);  // e1, e2 are having motions for x and y both, how ?
	...
	public void run() {
		while (running) {
			repaint();
			this.p.update(this);
			this.e1.update(this, "horizontal");
			this.e2.update(this, "horizontal");
			this.e3.update(this, "vertical");
			this.e4.update(this, "vertical");
			try {
				Thread.sleep(20);
			}
